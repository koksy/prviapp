...
class ShoesControllerTest < ActionController::TestCase
  ...
  test "should create shoe" do
    assert_difference('Shoe.count') do
      post :create, shoe: { description: @shoe.description, name: @shoe.name, price: @shoe.price, size: @shoe.size }
    end
  ...
  test "should update shoe" do
    put :update, id: @shoe, shoe: { description: @shoe.description, name: @shoe.name, price: @shoe.price, size: @shoe.size }
    assert_redirected_to shoe_path(assigns(:shoe))
  end
